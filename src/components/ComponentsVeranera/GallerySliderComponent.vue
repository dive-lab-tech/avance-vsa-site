...
class="mySwiper w-full"
  ...
  :breakpoints="{
      ...
      <SwiperSlide>
        <div class="flex justify-center"><img src="@/assets/image/images-veranera-a/VSA-Veranera-7.jpg"></div>
      </SwiperSlide>
      <SwiperSlide>
        <div class="flex justify-center"><img src="@/assets/image/images-veranera-a/VSA-Veranera-8.jpg"></div>
      </SwiperSlide>
      <SwiperSlide>
